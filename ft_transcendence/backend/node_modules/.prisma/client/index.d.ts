...
export namespace Prisma {
  ...
  */
  ...
  export type UserSelect = {
    ...
    friends?: boolean | FriendFindManyArgs
  ...
  export class Prisma__UserClient<T> implements PrismaPromise<T> {
    ...
    friends<T extends FriendFindManyArgs = {}>(args?: Subset<T, FriendFindManyArgs>): CheckSelect<T, PrismaPromise<Array<Friend>>, PrismaPromise<Array<FriendGetPayload<T>>>>;
  ...
  export type FriendGroupByArgs = {
    ...
    by: Array<FriendScalarFieldEnum>
  ...
  type GetFriendGroupByPayload<T extends FriendGroupByArgs> = PrismaPromise<
    Array<
  ...
  export type FriendGetPayload<
    S extends boolean | null | undefined | FriendArgs,
    U = keyof S
      > = S extends true
        ? Friend
    : S extends undefined
    ? never
    : S extends FriendArgs | FriendFindManyArgs
    ?'include' extends U
    ? Friend  & {
    [P in TrueKeys<S['include']>]:
    ...
    ? {
    [P in TrueKeys<S['select']>]:
        P extends 'user' ? UserGetPayload<S['select'][P]> :  P extends keyof Friend ? Friend[P] : never
  } 
    : Friend
  : Friend


  type FriendCountArgs = Merge<
    Omit<FriendFindManyArgs, 'select' | 'include'> & {
      select?: FriendCountAggregateInputType | true
    }
  >

  export interface FriendDelegate<GlobalRejectSettings> {
    /**
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'Friend'> extends True ? CheckSelect<T, Prisma__FriendClient<Friend>, Prisma__FriendClient<FriendGetPayload<T>>> : CheckSelect<T, Prisma__FriendClient<Friend | null >, Prisma__FriendClient<FriendGetPayload<T> | null >>
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'Friend'> extends True ? CheckSelect<T, Prisma__FriendClient<Friend>, Prisma__FriendClient<FriendGetPayload<T>>> : CheckSelect<T, Prisma__FriendClient<Friend | null >, Prisma__FriendClient<FriendGetPayload<T> | null >>
    ...
    **/
    ...
    ): CheckSelect<T, PrismaPromise<Array<Friend>>, PrismaPromise<Array<FriendGetPayload<T>>>>
    ...
    **/
    ...
    ): CheckSelect<T, Prisma__FriendClient<Friend>, Prisma__FriendClient<FriendGetPayload<T>>>
    ...
    **/
    ...
    /**
     * Find one Friend that matches the filter or throw
     * `NotFoundError` if no matches were found.
    ...
    **/
     ...
     * })
    **/
    aggregate<T extends FriendAggregateArgs>(args: Subset<T, FriendAggregateArgs>): PrismaPromise<GetFriendAggregateType<T>>
    ...
    **/
    ...
    >(args: SubsetIntersection<T, FriendGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetFriendGroupByPayload<T> : PrismaPromise<InputErrors>
  }
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__FriendClient<T> implements PrismaPromise<T> {
    [prisma]: true;
    private readonly _dmmf;
    private readonly _fetcher;
    private readonly _queryType;
   ...
   */
  export type FriendFindUniqueOrThrowArgs = FriendFindUniqueArgsBase
      

  /**
   * Friend: findFirstOrThrow
   */
  export type FriendFindFirstOrThrowArgs = FriendFindFirstArgsBase
  ...
  export type MatchHistoryGroupByArgs = {
    ...
    by: Array<MatchHistoryScalarFieldEnum>
  ...
  type GetMatchHistoryGroupByPayload<T extends MatchHistoryGroupByArgs> = PrismaPromise<
    Array<
  ...
  export type MatchHistoryGetPayload<
    S extends boolean | null | undefined | MatchHistoryArgs,
    U = keyof S
      > = S extends true
        ? MatchHistory
    : S extends undefined
    ? never
    : S extends MatchHistoryArgs | MatchHistoryFindManyArgs
    ?'include' extends U
    ? MatchHistory 
    : 'select' extends U
    ? {
    [P in TrueKeys<S['select']>]:
    P extends keyof MatchHistory ? MatchHistory[P] : never
  } 
    : MatchHistory
  : MatchHistory


  type MatchHistoryCountArgs = Merge<
    Omit<MatchHistoryFindManyArgs, 'select' | 'include'> & {
      select?: MatchHistoryCountAggregateInputType | true
    }
  >

  export interface MatchHistoryDelegate<GlobalRejectSettings> {
    /**
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'MatchHistory'> extends True ? CheckSelect<T, Prisma__MatchHistoryClient<MatchHistory>, Prisma__MatchHistoryClient<MatchHistoryGetPayload<T>>> : CheckSelect<T, Prisma__MatchHistoryClient<MatchHistory | null >, Prisma__MatchHistoryClient<MatchHistoryGetPayload<T> | null >>
    ...
    **/
    ...
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'MatchHistory'> extends True ? CheckSelect<T, Prisma__MatchHistoryClient<MatchHistory>, Prisma__MatchHistoryClient<MatchHistoryGetPayload<T>>> : CheckSelect<T, Prisma__MatchHistoryClient<MatchHistory | null >, Prisma__MatchHistoryClient<MatchHistoryGetPayload<T> | null >>
    ...
    **/
    ...
    ): CheckSelect<T, PrismaPromise<Array<MatchHistory>>, PrismaPromise<Array<MatchHistoryGetPayload<T>>>>
    ...
    **/
    ...
    ): CheckSelect<T, Prisma__MatchHistoryClient<MatchHistory>, Prisma__MatchHistoryClient<MatchHistoryGetPayload<T>>>
    ...
    **/
    ...
    /**
     * Find one MatchHistory that matches the filter or throw
     * `NotFoundError` if no matches were found.
    ...
    **/
     ...
     * })
    **/
    aggregate<T extends MatchHistoryAggregateArgs>(args: Subset<T, MatchHistoryAggregateArgs>): PrismaPromise<GetMatchHistoryAggregateType<T>>
    ...
    **/
    ...
    >(args: SubsetIntersection<T, MatchHistoryGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetMatchHistoryGroupByPayload<T> : PrismaPromise<InputErrors>
  }
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__MatchHistoryClient<T> implements PrismaPromise<T> {
    [prisma]: true;
    private readonly _dmmf;
    private readonly _fetcher;
    private readonly _queryType;
   ...
   */
  export type MatchHistoryFindUniqueOrThrowArgs = MatchHistoryFindUniqueArgsBase
      

  /**
   * MatchHistory: findFirstOrThrow
   */
  export type MatchHistoryFindFirstOrThrowArgs = MatchHistoryFindFirstArgsBase
  ...
  export type UserWhereInput = {
    ...
    two_factor_enabled?: BoolFilter | boolean
  ...
  export type UserScalarWhereWithAggregatesInput = {
    ...
    two_factor_enabled?: BoolWithAggregatesFilter | boolean
  ...
  export type FriendScalarWhereWithAggregatesInput = {
    ...
    status?: IntWithAggregatesFilter | number
    is_blocked?: BoolWithAggregatesFilter | boolean
  }
  ...
  export type MatchHistoryWhereInput = {
    ...
    id?: IntFilter | number
    user1?: IntFilter | number
    user2?: IntFilter | number
    user1_score?: IntFilter | number
    user2_score?: IntFilter | number
  ...
  export type MatchHistoryOrderByWithRelationInput = {
    ...
    user1?: SortOrder
    user2?: SortOrder
    user1_score?: SortOrder
    user2_score?: SortOrder
    createdAt?: SortOrder
  }
  ...
  export type MatchHistoryScalarWhereWithAggregatesInput = {
    ...
    id?: IntWithAggregatesFilter | number
    user1?: IntWithAggregatesFilter | number
    user2?: IntWithAggregatesFilter | number
    user1_score?: IntWithAggregatesFilter | number
    user2_score?: IntWithAggregatesFilter | number
  ...
  export type MatchHistoryUpdateInput = {
    ...
    user1_score?: IntFieldUpdateOperationsInput | number
    user2_score?: IntFieldUpdateOperationsInput | number
